...
interface INeo4jService_ICreateUser
  extends grpc.MethodDefinition<
    proto_neo4j_pb.CreateUserRequest,
    proto_neo4j_pb.CreateUserResponse
  > {
...
interface INeo4jService_ICreateMatch
  extends grpc.MethodDefinition<
    proto_neo4j_pb.CreateMatchRequest,
    proto_neo4j_pb.CreateMatchResponse
  > {
...
interface INeo4jService_IUpdateMatch
  extends grpc.MethodDefinition<
    proto_neo4j_pb.UpdateMatchRequest,
    proto_neo4j_pb.UpdateMatchResponse
  > {
...
interface INeo4jService_ICreateFeedback
  extends grpc.MethodDefinition<
    proto_neo4j_pb.CreateFeedbackRequest,
    proto_neo4j_pb.StandardResponse
  > {
...
interface INeo4jService_IGetRelationshipScores
  extends grpc.MethodDefinition<
    proto_neo4j_pb.GetRelationshipScoresRequest,
    proto_neo4j_pb.GetRelationshipScoresResponse
  > {
...
interface INeo4jService_ICheckUserFilters
  extends grpc.MethodDefinition<
    proto_neo4j_pb.CheckUserFiltersRequest,
    proto_neo4j_pb.CheckUserFiltersResponse
  > {
...
interface INeo4jService_IUpdatePerferences
  extends grpc.MethodDefinition<
    proto_neo4j_pb.UpdatePerferencesRequest,
    proto_neo4j_pb.StandardResponse
  > {
...
interface INeo4jService_IGetUserPerferences
  extends grpc.MethodDefinition<
    proto_neo4j_pb.GetUserPerferencesRequest,
    proto_neo4j_pb.GetUserPerferencesResponse
  > {
...
interface INeo4jService_IPutUserPerferences
  extends grpc.MethodDefinition<
    proto_neo4j_pb.PutUserPerferencesRequest,
    proto_neo4j_pb.PutUserPerferencesResponse
  > {
...
interface INeo4jService_IGetMatchHistory
  extends grpc.MethodDefinition<
    proto_neo4j_pb.MatchHistoryRequest,
    proto_neo4j_pb.MatchHistoryResponse
  > {
...
export interface INeo4jServer {
  createUser: grpc.handleUnaryCall<
    ...
    proto_neo4j_pb.CreateUserResponse
  >;
  createMatch: grpc.handleUnaryCall<
    proto_neo4j_pb.CreateMatchRequest,
    proto_neo4j_pb.CreateMatchResponse
  >;
  updateMatch: grpc.handleUnaryCall<
    proto_neo4j_pb.UpdateMatchRequest,
    proto_neo4j_pb.UpdateMatchResponse
  >;
  createFeedback: grpc.handleUnaryCall<
    proto_neo4j_pb.CreateFeedbackRequest,
    proto_neo4j_pb.StandardResponse
  >;
  getRelationshipScores: grpc.handleUnaryCall<
    proto_neo4j_pb.GetRelationshipScoresRequest,
    proto_neo4j_pb.GetRelationshipScoresResponse
  >;
  checkUserFilters: grpc.handleUnaryCall<
    proto_neo4j_pb.CheckUserFiltersRequest,
    proto_neo4j_pb.CheckUserFiltersResponse
  >;
  updatePerferences: grpc.handleUnaryCall<
    proto_neo4j_pb.UpdatePerferencesRequest,
    proto_neo4j_pb.StandardResponse
  >;
  getUserPerferences: grpc.handleUnaryCall<
    proto_neo4j_pb.GetUserPerferencesRequest,
    proto_neo4j_pb.GetUserPerferencesResponse
  >;
  putUserPerferences: grpc.handleUnaryCall<
    proto_neo4j_pb.PutUserPerferencesRequest,
    proto_neo4j_pb.PutUserPerferencesResponse
  >;
  getMatchHistory: grpc.handleUnaryCall<
    proto_neo4j_pb.MatchHistoryRequest,
    proto_neo4j_pb.MatchHistoryResponse
  >;
}
...
export interface INeo4jClient {
  createUser(
    request: proto_neo4j_pb.CreateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.CreateUserResponse,
    ) => void,
  ...
  createMatch(
    request: proto_neo4j_pb.CreateMatchRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.CreateMatchResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  createMatch(
    request: proto_neo4j_pb.CreateMatchRequest,
  ...
  updateMatch(
    request: proto_neo4j_pb.UpdateMatchRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.UpdateMatchResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  updateMatch(
    request: proto_neo4j_pb.UpdateMatchRequest,
  ...
  createFeedback(
    request: proto_neo4j_pb.CreateFeedbackRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.StandardResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  createFeedback(
    request: proto_neo4j_pb.CreateFeedbackRequest,
  ...
  getRelationshipScores(
    request: proto_neo4j_pb.GetRelationshipScoresRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.GetRelationshipScoresResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  getRelationshipScores(
    request: proto_neo4j_pb.GetRelationshipScoresRequest,
  ...
  checkUserFilters(
    request: proto_neo4j_pb.CheckUserFiltersRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.CheckUserFiltersResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  checkUserFilters(
    request: proto_neo4j_pb.CheckUserFiltersRequest,
  ...
  updatePerferences(
    request: proto_neo4j_pb.UpdatePerferencesRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.StandardResponse,
    ) => void,
  ...
  getUserPerferences(
    request: proto_neo4j_pb.GetUserPerferencesRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.GetUserPerferencesResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  getUserPerferences(
    request: proto_neo4j_pb.GetUserPerferencesRequest,
  ...
  putUserPerferences(
    request: proto_neo4j_pb.PutUserPerferencesRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.PutUserPerferencesResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  putUserPerferences(
    request: proto_neo4j_pb.PutUserPerferencesRequest,
  ...
  getMatchHistory(
    request: proto_neo4j_pb.MatchHistoryRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_neo4j_pb.MatchHistoryResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  getMatchHistory(
    request: proto_neo4j_pb.MatchHistoryRequest,
