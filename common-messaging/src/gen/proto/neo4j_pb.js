...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.neo4j.EndCallRequest.prototype.toObject = function (
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.neo4j.EndCallRequest}
 */
proto.neo4j.EndCallRequest.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.neo4j.EndCallRequest.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.neo4j.MatchHistoryRequest.prototype.getSkip = function () {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.neo4j.MatchHistoryRequest} returns this
 */
proto.neo4j.MatchHistoryRequest.prototype.setSkip = function (value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
