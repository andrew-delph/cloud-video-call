...
`,
  ...
  result = await session.run(
    ...
    CALL gds.beta.pipeline.linkPrediction.predict.stream('myGraph', {
     ...
     MATCH (person1)-[r1:USER_DEFINED_MD]-(md1:MetaData{gender:"femalepicky"}), (person2)-[r2:USER_DEFINED_MD]-(md2:MetaData) OPTIONAL MATCH (person1)-[f:FRIENDS]-(person2)
     RETURN person1.userId,  person2.userId, probability, md1.gender as gender1, md2.gender as gender2, md2.hot as f
